...
fun getItemUserTransformation() = RequestOptions.bitmapTransform(BlurTransformation(14, 7))

fun getItemPostTransformation() = RequestOptions.bitmapTransform(BlurTransformation(2, 7))